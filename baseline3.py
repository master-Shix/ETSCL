...
class Model(nn.Module):
    def __init__(self):
        ...
        #这里哦
        self.decision_branch = nn.Linear(2048 , 3)  # ResNet50 use basic block, expansion = 1
    ...
    def forward(self, fundus_img, oct_img):
        ...
        #concatenated_features = torch.cat([b1, b2], 1)
        #print("Concatenated features shape:", concatenated_features.shape)

        #logit = self.decision_branch(concatenated_features)
        logit = self.decision_branch(b2)
